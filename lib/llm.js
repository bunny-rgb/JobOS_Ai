...
export const MODELS = [
  ...
  { id: 'gemini-2.5-pro', label: 'Gemini 2.5 Pro (may hit quota)', provider: 'gemini', endpoint: 'gemini-2.5-pro' },
  ...
  { id: 'anthropic/claude-sonnet-4.5', label: 'Claude Sonnet 4.5 (via OpenRouter)', provider: 'openrouter', endpoint: 'anthropic/claude-sonnet-4.5' },
